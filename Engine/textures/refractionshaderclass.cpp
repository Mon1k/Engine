...
bool RefractionShaderClass::Initialize(ID3D11Device* device)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, L"./data/shaders/refraction.vs", L"./data/shaders/refraction.ps");
	if (!result) {
		return false;
	}
...
bool RefractionShaderClass::InitializeShader(ID3D11Device* device, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
