...
bool FoliageShaderClass::Initialize(ID3D11Device* device)
{
	return InitializeShader(device, L"./data/shaders/foliage.vs", L"./data/shaders/foliage.ps");
}
...
bool FoliageShaderClass::InitializeShader(ID3D11Device* device, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
